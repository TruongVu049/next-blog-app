  ...
  return (
    <>
        ...
        <NofiModal onClose={() => router.push("/dang-nhap")}>
          <div className="text-center">
            {dataForm.status ? (
              ...
              <ExclamationCircleIcon className="mx-auto w-12 h-12 text-red-600" />
            )}
          </div>
      ...
      <form className="w-full" onSubmit={handleSubmit}>
        ...
        <SubmitButton
          cName={
            "text-white w-full bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center "
          }
          title={"Đăng ký"}
        />
      </form>
